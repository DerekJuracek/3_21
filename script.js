  ...
  if (loader !== "Zip_Code" && loader !== "County") {
    ...
    popup
      ...
      .setHTML(
       ...
       <nobr><strong>Homes w/ at least one child under 18 years old: </strong>${childUnder18}% <br><nobr><strong>Black Householders: </strong>${blackAlone}%<br>
        <nobr><strong>Homes w/ at least one person w/ Disability: </strong>${disab}%<nobr><br><strong>Asian Householders: </strong>${asianAlone}%<nobr><br><nobr><strong>American Indian Householders: </strong>${amIndianAlone}%
